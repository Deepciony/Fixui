...
declare module "$app/types" {
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/organizer/settings/_components": Record<string, never>;
			"/organizer/unlock": Record<string, never>;
			"/organizer/unlock/_components": Record<string, never>;
			"/organizer/verify-code": Record<string, never>;
			"/organizer/verify-code/_components": Record<string, never>;
			"/organizer/verify-proof": Record<string, never>;
			"/organizer/verify-proof/_components": Record<string, never>;
